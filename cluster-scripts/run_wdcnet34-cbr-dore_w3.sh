...
#find
cd $LS_SUBCWD
python3 main.py -a weightcompnet34 -m "rgb-dore-d3dwor" --depth-weight-head-type CBR -s 0 -c l2gn -lr 0.001 -lrs 6 -lrm 0.00001 --depth-divider 100 --epochs 200 --pretrained resnet --data-path $TMPDIR/data/

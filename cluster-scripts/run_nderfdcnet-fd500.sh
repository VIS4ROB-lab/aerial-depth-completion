...
cd $LS_SUBCWD
python3 main.py -a nderfdepthcompnet -m "rgb-fd" -s 500 -c l2n_dual -lr 0.0001 --batch-size 8 -j 16 -lrs 3 -lrm 0.000001 --depth-divider 1  --epochs 200 --pretrained resnet --data-path $TMPDIR/data/

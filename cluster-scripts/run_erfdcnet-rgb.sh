...
cd $LS_SUBCWD
python3 main.py -a erfdepthcompnet -m "rgb" -s 0 -c l2 -lr 0.00001 --batch-size 8 -j 16 -lrs 3 -lrm 0.000001 --depth-divider 1  --epochs 200 --pretrained resnet --data-path $TMPDIR/data/

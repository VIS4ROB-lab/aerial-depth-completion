...
cd $LS_SUBCWD
python3 main.py -a resnet18 -m "rgb-fd" -s 10000 -c l2 -lr 0.001 --batch-size 8 -j 16 -lrs 3 -lrm 0.00001 --depth-divider 1  --epochs 200 --pretrained resnet --data-path $TMPDIR/data/
